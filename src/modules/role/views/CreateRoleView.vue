  ...
  <div class="card mt-5 border-0 shadow-sm">
    ...
    <div class="card-body">
      ...
      <div class="mt-3 mx-1 size border p-4 row" >
        <h6>Selecionar Permissões</h6>
        <div v-for="role in permissions" :key="role.id" class="col-4">
          <h6><small>{{ role.name }}</small></h6>
...
export default {
  ...
  methods: {
    saveRole() {
      ...
      //RoleService.createRole({ name: this.roleName, description: this.description, permissions: this.selectedPermissions });
    }
  },
}
</script>
